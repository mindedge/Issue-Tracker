<!-- Begin reports/tech.tpl -->
<form method="post" action="?module=reports&action=generate&tech=true">
{opentable}
{titlebar title="Report Options"}
<tr><td class="label">Users:</td></tr>
<tr>
<td class="data">
<select name="userid[]" size="10" multiple="multiple=" style="width: 99%;">
